...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.288293, 76.964815); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.283341, 76.966818); // Маркер 1
    static final LatLng marker2 = new LatLng(52.274932, 76.990300); // Маркер 2
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.sport)).alpha(ALPHA).
